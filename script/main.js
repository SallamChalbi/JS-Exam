let rowContaine = document.getElementById("rowContaine");
let searchContaine = document.getElementById("searchContaine");
let submitBtn;
...
async function getCategories() {
    rowContaine.innerHTML = ""
    $(".inner-loading-screen").fadeIn(300)
    searchContaine.innerHTML = "";
...
function showContacts() {
    rowContaine.innerHTML = `<div class="contact min-vh-100 d-flex justify-content-center align-items-center">
